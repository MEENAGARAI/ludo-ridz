...
def finishingBox():
    ...
    finishingBox = Label(gameWindow, text="Home", font=("Chalkboard SE", 32), width=7, height=3, borderwidth=0, bg="green", fg="white")
    finishingBox.place(x=screen_width/2 - 100, y=screen_height/2 -160)
...
def gameWindow():
    ...
    rollButton = Button(gameWindow,text="Roll Dice", fg='black', font=("Chalkboard SE", 15), bg="grey",command=rollDice, width=16, height=5)
